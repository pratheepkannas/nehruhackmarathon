...
const shortlistedTeams = [
  ...
  { teamId: "TF003", teamName: "Phantom Hackers", collegeName: "Nadar College of Arts and Science", domain: "Fintech and Digital Economy" },
  ...
  { teamId: "TNL08", teamName: "Weekend Coders", collegeName: "KG College Of Arts and Science", domain: "NLP" },
  { teamId: "TNL09", teamName: "MindGuard", collegeName: "Dr.NGP Arts and Science College", domain: "NLP" },
  { teamId: "TNL10", teamName: "Upstream", collegeName: "Dr.NGP Arts and Science College", domain: "NLP" },
  { teamId: "TNL11", teamName: "Necromancers", collegeName: "Rathinam Groups Of Institution", domain: "NLP" },
  { teamId: "TNL12", teamName: "Tech Titans", collegeName: "Karpagam Academy Of Higher Education", domain: "NLP" },
  { teamId: "TNL13", teamName: "TaskGuardians", collegeName: "Sri Ramakrishna Engineering College", domain: "NLP" },
  { teamId: "TNL14", teamName: "Wolf", collegeName: "Sri Krishna Adithya", domain: "NLP" },
  { teamId: "TH015", teamName: "Blood Bridge", collegeName: "KGISL College", domain: "Healthcare" },
  { teamId: "TH016", teamName: "Magneta", collegeName: "Kgisl Institute of technology", domain: "Healthcare" },
  { teamId: "TH017", teamName: "Eclipse Syndicate", collegeName: "KG College of Arts and Science", domain: "Healthcare" },
  { teamId: "TH018", teamName: "Think AI", collegeName: "KPR College of Arts and Science", domain: "Healthcare" },
  { teamId: "TH019", teamName: "Quadmith Tech", collegeName: "Presidency University", domain: "Healthcare" },
  { teamId: "TH020", teamName: "CloudNexus", collegeName: "Hindusthan college of Arts and Science", domain: "Healthcare" },
  { teamId: "TC021", teamName: "Hashers", collegeName: "Sri Ramakrishna college of Arts and Science", domain: "Cybersecurity" },
  { teamId: "TC022", teamName: "Digital Defender", collegeName: "Karpagam Academy Of Higher Education", domain: "Cybersecurity" },
  { teamId: "TC023", teamName: "Lightning Logics", collegeName: "Sri Krishna Arts and Science", domain: "Cybersecurity" },
  { teamId: "TC024", teamName: "Nexora", collegeName: "Sri Ramakrishna Arts and Science for women", domain: "Cybersecurity" },
  { teamId: "TC025", teamName: "Team Ghost Arsenal", collegeName: "Dr N.G.P Arts and Science college", domain: "Cybersecurity" },
  { teamId: "TC026", teamName: "Odyssey", collegeName: "Sri Ramakrishna college of Arts and Science", domain: "Cybersecurity" },
];
