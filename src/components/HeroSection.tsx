...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-24 md:pb-8">
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        >
          <img 
            src={nascHeader} 
            alt="Nehru Arts and Science College" 
            className="max-w-full h-auto mx-auto max-h-16 md:max-h-24 lg:max-h-28 object-contain drop-shadow-glow"
          />
        </motion.div>
        ...
        >
          ...
          <a 
            href="#about"
            className="w-full sm:w-auto px-8 py-4 rounded-xl glass-card font-display font-semibold text-lg 
